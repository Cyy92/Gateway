...
func Deploy(req *pb.CreateFunctionRequest, clientset *kubernetes.Clientset, config *DeployHandlerConfig) error {
	...
	*/
	...
	deployHPA := clientset.AutoscalingV2().HorizontalPodAutoscalers(config.FunctionNamespace)
...
func makeAutoscaleSpec(req *pb.CreateFunctionRequest) (*v2.HorizontalPodAutoscaler, error) {
	hpaSpec := &v2.HorizontalPodAutoscaler{
		TypeMeta: metav1.TypeMeta{
			...
			Metrics: []v2.MetricSpec{
				{
					...
					Resource: &v2.ResourceMetricSource{
						...
						Target: v2.MetricTarget{
							...
							AverageUtilization: int32p(initialCpuUtilization),
						},
					},
				},
			},
