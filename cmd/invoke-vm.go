...
func InvokeVM(service string, VMNamespace string, fxWatcherPort int, input []byte, timeout time.Duration) (string, error) {

	address := fmt.Sprintf("%s.%s:%d", service, VMNamespace, fxWatcherPort)
